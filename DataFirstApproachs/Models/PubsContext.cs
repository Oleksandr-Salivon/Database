...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data source=KANINI-LTP-455\\SQLSERVER2019G3;user id=sa;password=Admin@123;Initial catalog=Pubs");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.EmpId)
                    .HasName("PK__employee__AFB3EC0D564169C4");
            ...
            modelBuilder.Entity<Empsal>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("empsal");
                ...
                entity.HasOne(d => d.Emp)
                    ...
                    .HasConstraintName("FK__empsal__empid__1BC821DD");

                entity.HasOne(d => d.Sal)
                    .WithMany()
                    .HasForeignKey(d => d.Salid)
                    .HasConstraintName("FK__empsal__salid__1CBC4616");
            });
            ...
            modelBuilder.Entity<Salary>(entity =>
            {
                entity.HasKey(e => e.SalId)
                    .HasName("PK__salary__E3E892965B86F48D");
            ...
            modelBuilder.Entity<TblTriggerCheck>(entity =>
            {
                entity.HasKey(e => e.F1)
                    .HasName("PK__tblTrigg__32139E584197D505");
            ...
            modelBuilder.Entity<Tblanotheremployee>(entity =>
            {
                ...
                entity.HasOne(d => d.Emp)
                    .WithMany()
                    .HasForeignKey(d => d.Empid)
                    .HasConstraintName("FK__tblanothe__empid__236943A5");
            });
